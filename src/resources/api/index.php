 ...
 *   GET    /resources/api/index.php?id={id}                                  - Get single resource
 *   POST   /resources/api/index.php                                          - Create resource
 *   PUT    /resources/api/index.php                                          - Update resource
 *   DELETE /resources/api/index.php?id={id}                                  - Delete resource
 *   GET    /resources/api/index.php?resource_id={id}&action=comments         - Get comments
 *   POST   /resources/api/index.php?action=comment                           - Create comment
 *   DELETE /resources/api/index.php?comment_id={id}&action=delete_comment    - Delete comment
 */

// ============================================================================
// HELPER FUNCTIONS  (defined first so catch blocks and routers can call them)
// ============================================================================
...
/**
 * GET all resources.
 * Supports optional ?search=, ?sort=, ?order= query parameters.
 */
...
/**
 * DELETE — remove a resource (CASCADE handles associated comments).
 */
